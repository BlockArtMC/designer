...
import net.deechael.designer.data.DataTableCreator;
import net.deechael.designer.data.Database;
...
public class MysqlDatabase implements Database {
    ...
    @Override
    public @NotNull <T extends DataHolder> DataTableCreator<T> initializeTable(@NotNull Class<T> dataClass) {
